...
class ApprovedPropertyListWidget extends StatefulWidget {
  const ApprovedPropertyListWidget({super.key});

  @override
  State<ApprovedPropertyListWidget> createState() =>
      _ApprovedPropertyListWidgetState();
}

class _ApprovedPropertyListWidgetState
    extends State<ApprovedPropertyListWidget> {
  @override
    ...
    return BlocListener<OwnerPropertyDetailsCubit, OwnerPropertyDetailsState>(
      listener: (context, state) {
        if (state is DeletePropertySuccess) {
          ...
          context.read<OwnerHomeCubit>().getPropertyList(isSoldOut: false);
        }
      },
        ...
        child: cubit.filteredPropertyList != null &&
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Render each approved property item
                  ...
                  return Padding(
                    ...
                    child: PropertyListItem(
                      ...
                      propertyPriceCurrency:
                          propertyData.price?.currencySymbol ?? '', isVisitor: false,isSoldOut:false
                    ),
                  );
                },
