...
class ApprovedVendorOfferWidget extends StatelessWidget {
  const ApprovedVendorOfferWidget({super.key});
  ...
  Widget _buildOffersListContent(
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: Skeletonizer(
        ...
        child: cubit.filteredAddMyOffers != null &&
                cubit.filteredAddMyOffers!.isEmpty
            ? Center(
                child: UIComponent.noDataWidgetWithInfo(
            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  OfferData myOffersListData =
                      cubit.filteredAddMyOffers?[index] ?? OfferData();
                  myOffersListData.companyLogo =
                      cubit.userSavedData?.users?.companyLogo ?? "";
                  return Padding(
                    padding: EdgeInsets.only(
                      bottom:
                          index == (cubit.filteredAddMyOffers?.length ?? 0) - 1
                              ? 78
                              : 0,
                    ),
                      ...
                      onTap: () {
                        context.pushNamed(Routes.kOfferDetailScreen,
                            pathParameters: {
                              ...
                              RouteArguments.offerId: myOffersListData.sId?.trim() ?? "",
                            },
                ...
                itemCount: (cubit.filteredAddMyOffers?.length ?? 0) +
