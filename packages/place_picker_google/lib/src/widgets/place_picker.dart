...
/// JORDAN as default location
class PlacePicker extends StatefulWidget {
  static const LatLng defaultLocation = LatLng(31.952775, 35.939847); // Downtown Amman
...
class PlacePickerState extends State<PlacePicker>
  ...
  Future<void> _setCustomMarker() async {
    customIcon = await BitmapDescriptor.asset(
      ...
      'assets/icons/ic_location_pin_icon.png', // Path to your custom marker image
    );
    setState(() {}); // Rebuild to show the marker once loaded
  ...
  void autoCompleteSearch(String place) async {
    try {
      ...
      print("usingAPIKEy ${widget.apiKey}");
